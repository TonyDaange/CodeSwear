            ...
            >
              ...
              <ol className="font-semibold text-xl flex-1 overflow-y-auto overflow-x-hidden">
                {Object.entries(cart).map(([itemName, quantity]) => (
                  <li key={itemName} className="flex items-center my-2">
              ...
              <div className="bg-gray-900 py-4 px-5 border-t border-gray-700 flex-shrink-0 flex lg:justify-between lg:space-x-5 lg:flex-row flex-col space-y-3">
                ...
                <button className="w-full text-white bg-blue-600 border-0 py-2 lg:py-0 px-8 focus:outline-none hover:bg-blue-500 rounded text-xl font-semibold flex justify-center items-center lg:h-18">
