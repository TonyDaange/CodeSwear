        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="lg:text-3xl text-2xl font-medium title-font mb-2 text-white">
              Wear the Code with Codeswear
            </h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-opacity-80 lg:text-2xl text-xl">
              Wear whatever you want? What do you want? You want code so why not
              wear the code??
            </p>
            <p className="lg:w-1/2 w-full leading-relaxed text-opacity-80 lg:text-2xl text-xl">
              Wear whatever you want? What do you want? You want code so why not
